...
faq:
  - q: ¿Cuánto tiempo tarda en promedio construir una casa?
    a: Una vivienda de 80-120 m² de nivel económico o medio tarda entre 6 y 12 meses en obra, dependiendo de la cantidad de trabajadores, la disponibilidad de materiales y si hubo interrupciones. Las obras premium o con mayor complejidad arquitectónica pueden superar los 18 meses. El plazo también varía mucho si hay lluvias, feriados o problemas de financiamiento.
  - q: ¿Qué hago si el presupuesto se va de las manos a mitad de obra?
    a: Lo primero es no parar la obra abruptamente — una estructura a medio construir se deteriora y el retomar cuesta más. Revisá con el maestro de obras qué etapas son críticas para cerrar el ciclo (por ejemplo, no dejar la losa expuesta sin impermeabilizar). Luego priorizá por etapas y diferí los acabados que no son estructurales. Si el problema es de raíz, buscá financiamiento antes de continuar, no después.
  - q: ¿Cuánto vale el metro cuadrado de mano de obra sola, sin materiales?
    a: En promedio regional, la mano de obra representa el 25-35% del costo total. En términos absolutos, oscila entre USD 80-150/m² en países como Perú, Bolivia o Ecuador, y puede superar USD 200/m² en Chile o México con cuadrillas formales. El dato varía enormemente según si los trabajadores son informales o están en planilla, y si incluye cargas sociales.
  - q: ¿Cómo financiar la construcción si no tengo todo el capital?
    a: Las opciones más comunes son créditos hipotecarios de autoproducción (muchos bancos financian hasta el 70-80% del presupuesto aprobado contra avance de obra), ahorros programados con desembolso por etapas, o créditos de materiales directo con ferreterías de mayor volumen. Lo clave es tener al menos el 30-40% propio antes de empezar, para no quedar expuesto si el crédito tarda.
related:
...
Para entender qué papel juegan estos materiales en la estructura, mirá qué es [el hormigón armado](/posts/que-es-el-hormigon-armado/) y los distintos [tipos de cimentación](/posts/tipos-de-cimentacion-en-construccion/) que inciden directamente en el costo de la etapa más cara.
...
La etapa de cimentación y estructura es donde **no se puede escatimar**. Si la estructura falla, el resto del edificio falla. Para dimensionar bien esa etapa, entendé los distintos tipos de estructuras y sistemas antes de decidir. Un buen artículo de base es [diferencia entre arquitectura y construcción](/posts/diferencia-entre-arquitectura-y-construccion/).
...
```
Costo base = Área construida (m²) × Costo unitario (USD/m²)
```

Ejemplo: 100 m² × USD 400/m² (nivel medio, Perú) = **USD 40.000**
...
Presupuestar bien es Paso 0 de cualquier obra. Para las etapas que más pesan en el costo — cimentación, estructura y paredes — te recomendamos revisar [los tipos de cimentación](/posts/tipos-de-cimentacion-en-construccion/), entender [cuántos ladrillos van por metro cuadrado](/posts/cuantos-ladrillos-por-metro-cuadrado-de-pared/) para estimar la mampostería, y conocer [el hormigón armado](/posts/que-es-el-hormigon-armado/) que es la base estructural de casi toda vivienda moderna.
